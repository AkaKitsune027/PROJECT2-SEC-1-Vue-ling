...
<template>
  ...
  <div v-if="isModalVisible"
    class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 font-sunday">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full h-64">
      ...
      <span class="mb-2 text-sm">
        ...
        <p class="text-sm text-[#b12c2c]">
          this action will permanently delete all your related data, and once the process is complete, it cannot be
          undone.
        </p>
      </span>
      ...
      <div class="flex gap-2 mt-6">
        ...
        <input type="password" v-model="currentPassword" placeholder="your password..."
