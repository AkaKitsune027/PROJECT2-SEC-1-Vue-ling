...
let clickCount = ref(0) // Track the number of ingredient clicks
const handleIngredientClick = async (targetIngredient) => {

    if (clickCount.value >= 14) return
    clickCount.value++
    ...
    <div class="relative flex flex-col overflow-hidden rounded-r-xl">
        ...
        <div class="flex-none bg-base text-center text-xl font-rowdies p-2 ">
            <div class="flex-none bg-base text-center text-xl font-rowdies p-2 ">
                ...
                <div class="flex  rounded-lg">
                    ...
                    <div @click="handleSelectPage(1)"
                        class="flex-1 flex justify-center cursor-pointer bg-[#c3e0c1] hover:bg-[#90a58e] rounded-lg border border-white ">
                        class="flex-1 flex justify-center cursor-pointer bg-[#c3e0c1] hover:bg-[#90a58e] rounded-lg
                        border border-white ">
            ...
            <div
                ...
                <button @click="handleIngredientClick(meat)" v-show="selectedPage === 0" v-for="meat in meats" <button
                    @click="handleIngredientClick(meat)" v-show="selectedPage === 0" v-for="meat in meats"
