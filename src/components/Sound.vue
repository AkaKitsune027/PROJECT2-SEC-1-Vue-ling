...
function playBackgroundMusic() {
    soundStore.playSound('bgm', '/sounds/background.mp3')  // เปลี่ยนเส้นทางไฟล์เสียงให้ถูกต้อง
}
</script>
 
<template>
    <div>
        <button class="bg-[#ACC6AA] flex justify-center items-center w-12 rounded-lg h-10" @click="toggleBgm">
            <div class="m-2 cursor-pointer group">
                <svg v-if="soundStore.isBgmPlaying" class="group-hover:fill-slate-500" xmlns="http://www.w3.org/2000/svg"
                    width="35" height="35" fill="white" viewBox="0 0 16 16">
                    <path
                ...
                <svg v-else class="group-hover:fill-slate-500" width="35" height="35" viewBox="0 0 35 35" fill="#f44"
