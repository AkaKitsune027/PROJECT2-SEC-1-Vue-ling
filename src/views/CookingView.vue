  ...
  <div class="w-screen h-[4rem] p-3 z-50 fixed top-0 bg-transparent">
    <div class="flex justify-between">
      <RouterLink to="/homepage">
        <button
          class="hover:shadow-md w-12 transform transition-transform duration-300 hover:scale-110">
  ...
  <div
    ...
    <div class="row-start-6 col-start-1 pt-2">
      ...
      <div class="bg-zinc-700 h-[5rem] rounded-r-xl grid place-items-center">
        <button
          @click="handleToggleFoodStoreClick"
          :disabled="gameState.isPreparePhase === false"
    ...
    <div
      @click="handleOrderSignClick"
      class="col-start-5 row-start-1 flex justify-center">
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div
              class="animate-ping absolute h-full w-full rounded-full bg-red-600 opacity-75"></div>
    ...
    <div
      v-show="isShow"
      class="col-start-5 row-start-3 row-span-1 flex flex-col justify-center items-center">
